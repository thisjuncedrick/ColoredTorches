**Because one torch color is just not enough.**

Vanilla torches get the job done, sure. But when you've spent hours decorating your farm down to the last fence post, a plain torch glow just doesn't cut it anymore. Craftable Colored Torches adds six craftable torch variants: Red, Orange, Yellow, Green, Blue, and Purple, each emitting its own colored light.
...
- 1 Torch (vanilla)
- 1 item matching the color's context tag

The ingredient is flexible, it matches by color tag, not a specific item. Red torches accept anything tagged red, pink, salmon, or dark red. Blue accepts anything cyan, aquamarine, or blue-toned. You get the idea.

### Configuration
Fully compatible with Generic Mod Config Menu. Accessible from the title screen or in-game:
- **Color (RGB)**: Set the exact light color using comma-separated RGB values (e.g. 255, 0, 100).
- **Radius**: Controls how far the light reaches. Range: 0.1 – 5.0.
- **Intensity**: Controls the brightness and transparency of the light. Range: 0% – 100%.

### Installation
1. Install the latest version of [**SMAPI**](https://smapi.io/).
2. Install [**Content Patcher**](https://www.nexusmods.com/stardewvalley/mods/1915).
3. Install [SpaceCore](https://www.nexusmods.com/stardewvalley/mods/1348).
4. (Optional but recommended) Install **Generic Mod Config Menu** to configure torch colors in-game.
5. Download this mod and unzip it into your Stardew Valley/Mods folder.
...
### Support
If your farm is now bathed in the exact shade of purple you always wanted,  consider leaving an endorsement on the Nexus page. It goes a long way in helping others discover it. **Thank you for trying it out :)**